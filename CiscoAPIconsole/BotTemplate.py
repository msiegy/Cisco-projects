...
client_id = "Pull from .env file or enter ASD API client ID directly here"
client_secret = "Pull from .env file or enter ASD API Secret directly here"
bearer = "ENTER BOT ACCESS TOKEN HERE"
...
#Define a message that helps users figure out what the bot can do.
def help_me():
...
"""Add another function that handles getting HW EoX info when provided with a PID and returning that info as a message."""
